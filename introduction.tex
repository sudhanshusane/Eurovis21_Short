...
%
%\fix{(Please refer to Sec. 3.1-3.3 for technical details/definitions regarding attribute space, traits, distance fields, feature level-sets, and secondary feature structures.)}%
...
%
To extract the zero level-set and the corresponding feature confidence level-sets, our approach utilizes multiple distance fields computed in the spatial domain directly.
%
...
%
Further, to the best of our knowledge, we believe this work considers the previously unexplored area of uncertainty visualization for multivariate data. 
%
