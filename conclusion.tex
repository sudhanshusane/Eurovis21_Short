In this paper, we proposed feature confidence level-sets and demonstrated their use for uncertain multivariate \fix{(or bivariate?)} data sets.
%
...
%
Our study demonstrated the ability of the approach to visualize regions of uncertainty in relation to a specific trait or feature and the improved \fix{(topological discovery of)} secondary feature structure visualization that feature confidence level-sets offer.
