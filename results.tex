...
For the data from the SciVis 2020 contest Red Sea eddy simulation, we visualized anticyclonic~(red isosurfaces) and cyclonic~(blue isosurfaces) eddies in Figure~\ref{fig:rse}. 
%
